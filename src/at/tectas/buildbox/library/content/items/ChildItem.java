...
public class ChildItem extends ParentItem {
	...
	public ChildItem(Item parent, JsonObject json) throws NullPointerException {
		...
		JsonElement detail = json.get(Item.context
				.getString(R.string.detail_property));
		...
		this.version = Item.helper.tryGetStringFromJson(
				Item.context.getString(R.string.version_property), json);

		if (children != null) {
			Item child = Item.parser.parseJsonItem(this, children);
	...
	public Bundle parseItemToBundle() {
		...
		result.putString(Item.context.getString(R.string.item_type_property),
				Item.context.getString(R.string.item_child_type));

		result.putString(Item.context.getString(R.string.detailurl_property),
				this.detailUrl);
